...
class CreateCalificacionesCopilotosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('calificaciones_copilotos', function (Blueprint $table) {
            $table->increments('id');
            $table->timestamps();
            $table->string('valor');
    ...
    {
        Schema::dropIfExists('calificaciones_copilotos');
    }
}
