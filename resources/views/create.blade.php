    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
          @include('flash_message')
                    <form method="POST" action="{{ action('Card.store') }}">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input value="" id="nroCard" type="text" class="form-control{{ $errors->has('nroCard') ? ' is-invalid' : '' }}" name="nroCard" value="{{ old('nroCard') }}" required autofocus oninvalid="this.setCustomValidity('Campo obligatorio')"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" name="expiration" required autofocus oninvalid="this.setCustomValidity('Campo obligatorio')"
                                    oninput="setCustomValidity('')">*
